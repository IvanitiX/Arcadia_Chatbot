/*
	Based in the AlcaDesign's GitHub Gist making a web chat visor
	Just updated the repos to get the icons and Twitch-sided emotes
	Added function inspectGetParam() to extract channels who are written in GET flag 'see'.
	Example : <...>/chat.html?see=twitchplayspokemon-alcadesign-ivanitix
*/

var channels = inspectGetParam(), // Channels to initially join
	...
	for(var i in emotes) {
		...
		for(var j in e) {
			...
			if(typeof mote == 'string') {
				...
				splitText.splice(mote[0], 1, '<img class="emoticon" src="https://static-cdn.jtvnw.net/emoticons/v1/' + i + '/2.0">');
			}
		}
	}
